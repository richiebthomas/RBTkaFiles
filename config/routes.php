...
return function (RouteBuilder $routes): void {
    ...
    $routes->scope('/', function (RouteBuilder $builder): void {
        /*
         * Main file manager routes - serve directly at root
         */
        $builder->connect('/', ['controller' => 'Files', 'action' => 'index']);
        $builder->connect('/*', ['controller' => 'Files', 'action' => 'index']);
        $builder->connect('/test', ['controller' => 'Files', 'action' => 'test']);
        ...
        $builder->scope('/api', function (RouteBuilder $routes): void {
            ...
            $routes->delete('/delete', ['controller' => 'Files', 'action' => 'delete']);
            $routes->get('/download/*', ['controller' => 'Files', 'action' => 'download']);
            $routes->get('/preview/*', ['controller' => 'Files', 'action' => 'preview']);
            $routes->get('/file-info', ['controller' => 'Files', 'action' => 'fileInfo']);
            $routes->post('/print', ['controller' => 'Files', 'action' => 'print']);
            $routes->post('/lookup-user', ['controller' => 'Files', 'action' => 'lookupUser']);
